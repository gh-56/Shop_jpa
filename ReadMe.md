...
- AduditorAware 인터페이스 구현 => 스프링 빈으로 등록해줘야 한다.
- @EnableJpaAuditing 애노테이션을 스프링 설정 정보에 추가해야 된다.
  - Audit 기능 활성화
...
# Pageable
- 스프링 프레임워크, Spring Data JPA에서 페이징 관련 인터페이스
- 데이터 베이스에서 결과를 페이지로 나눠 가져오는데 사용
