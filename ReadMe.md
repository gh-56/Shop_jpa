...
- 유틸리티 객체
  ...
  - [타임리프 공식문서 유틸리티 오브젝트](https://www.thymeleaf.org/doc/tutorials/3.1/usingthymeleaf.html#appendix-b-expression-utility-objects)
...
- 영속성 컨텍스트(Persistence Context)를 통해 관리되는 엔티티가 변경되면 JPA가 해당 변경을 감지하여 트랜잭션이 커밋될 때, 데이터베이스와 변경을 동기화하는 작업을 수행.
- 
# Pageable
